  ...
  <main class="page">
    <section class="todo-box">
      ...
      <div class="list-title">
        ...
        <button class="tip-button" type="button" @click="toggleHelpTips">💡</button>
      </div>
      ...
      <p v-if="todos.length === 0" class="empty-text">暂无任务，请先添加一条任务。</p>
      ...
      <ul v-else class="todo-list">
        ...
        >
          ...
          <button class="delete-button" type="button" @click="deleteTodo(todo.id)">🗑️</button>
        </li>
      </ul>
